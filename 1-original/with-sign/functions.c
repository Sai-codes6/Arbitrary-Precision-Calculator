...
int digit_to_list(Dlist **head1, Dlist **tail1, Dlist **head2, Dlist **tail2, char *sign1, char *sign2, char *argv[])
{
    ...
    int i = 0, j = 0, digit1, digit2;      // variable declaration
    ...
    // traverse through the first operand
    while (str1[i] != '\0')
    {
    ...
    while (str2[j] != '\0') // traverse through the second operand
    {
        ...
        {
            digit2 = str2[j] - 48;                // convert to int and store in digit2
